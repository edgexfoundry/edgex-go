...
func TestAddEvent(t *testing.T) {
	...
	tests := []struct {
		...
		{"Valid - No Event ProfileName JSON", noEventProfile, common.ContentTypeJSON, noEventProfile.Event.ProfileName, noEventProfile.Event.DeviceName, false, http.StatusCreated},
		{"Valid - No Event SourceName JSON", noEventSourceName, common.ContentTypeJSON, noEventSourceName.Event.ProfileName, noEventProfile.Event.DeviceName, false, http.StatusCreated},
		...
		{"Valid - No Reading ProfileName JSON", noReadingProfileName, common.ContentTypeJSON, noReadingProfileName.Event.ProfileName, noReadingProfileName.Event.DeviceName, false, http.StatusCreated},
		...
		{"Valid - No Event ProfileName CBOR", noEventProfile, common.ContentTypeCBOR, noEventProfile.Event.ProfileName, noEventProfile.Event.DeviceName, false, http.StatusCreated},
		{"Valid - No Event SourceName CBOR", noEventSourceName, common.ContentTypeCBOR, noEventSourceName.Event.ProfileName, noEventProfile.Event.DeviceName, false, http.StatusCreated},
		...
		{"Valid - No Reading ProfileName CBOR", noReadingProfileName, common.ContentTypeCBOR, noReadingProfileName.Event.ProfileName, noReadingProfileName.Event.DeviceName, false, http.StatusCreated},
