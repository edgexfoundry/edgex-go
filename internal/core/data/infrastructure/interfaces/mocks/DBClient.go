...
func (_m *DBClient) ReadingsByDeviceNameAndResourceNamesAndTimeRange(deviceName string, resourceNames []string, start int64, end int64, offset int, limit int) ([]models.Reading, uint32, errors.EdgeX) {
	...
	var r1 uint32
	var r2 errors.EdgeX
	if rf, ok := ret.Get(0).(func(string, []string, int64, int64, int, int) ([]models.Reading, uint32, errors.EdgeX)); ok {
	...
	if rf, ok := ret.Get(1).(func(string, []string, int64, int64, int, int) uint32); ok {
		r1 = rf(deviceName, resourceNames, start, end, offset, limit)
	} else {
		r1 = ret.Get(1).(uint32)
	}

	if rf, ok := ret.Get(2).(func(string, []string, int64, int64, int, int) errors.EdgeX); ok {
