...
// AllEventsByDeviceName provides a mock function with given fields: offset, limit, name
func (_m *DBClient) AllEventsByDeviceName(offset int, limit int, name string) ([]models.Event, errors.EdgeX) {
