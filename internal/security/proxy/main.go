...
func Main(ctx context.Context, cancel context.CancelFunc, _ *mux.Router, _ chan<- bool) {
	...
	flags.FlagSet.BoolVar(&initNeeded, "init", false, "")
	flags.FlagSet.BoolVar(&resetNeeded, "reset", false, "")
	flags.FlagSet.StringVar(&userTobeCreated, "useradd", "", "")
	flags.FlagSet.StringVar(&userOfGroup, "group", "user", "")
	flags.FlagSet.StringVar(&userToBeDeleted, "userdel", "", "")
