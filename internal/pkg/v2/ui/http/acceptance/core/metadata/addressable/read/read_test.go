...
import (
	...
	"github.com/edgexfoundry/edgex-go/internal/pkg/v2/ui/http/acceptance/core/metadata/addressable/read/v2dot0"
...
// TestUseCaseAcceptanceRead verifies addressable add use-case endpoint returns expected result.
func TestUseCaseAcceptanceRead(t *testing.T) {
...
// TestBatchAcceptanceRead verifies addressable add via batch endpoint returns expected result.
func TestBatchAcceptanceRead(t *testing.T) {
	cancel, wg, router := metadata.NewSUT(t, []string{test.EnvNoSecurity}, []string{})
