...
import (
	...
	"github.com/edgexfoundry/edgex-go/internal/pkg/v2/ui/http/acceptance/core/metadata/addressable/create/v2dot0"
...
// TestUseCaseAcceptanceAdd verifies addressable add use-case endpoint returns expected result.
func TestUseCaseAcceptanceAdd(t *testing.T) {
...
// TestBatchAcceptanceAdd verifies addressable add via batch endpoint returns expected result.
func TestBatchAcceptanceAdd(t *testing.T) {
	cancel, wg, router := metadata.NewSUT(t, []string{test.EnvNoSecurity}, []string{})
