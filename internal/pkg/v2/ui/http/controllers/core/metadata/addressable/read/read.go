...
import (
	...
	"github.com/edgexfoundry/edgex-go/internal/pkg/v2/application/dto/v2dot0/core/metadata/addressable/read"
	"github.com/edgexfoundry/edgex-go/internal/pkg/v2/application/persistence/core/metadata"
	useCase "github.com/edgexfoundry/edgex-go/internal/pkg/v2/application/usecases/core/metadata/addressable/read"
...
const (
	...
	Kind    = application.KindAddressableRead
	Action  = application.ActionRead
	Method  = controllers.ActionRead
	...
	muxRouter.HandleFunc(
		...
		func(w http.ResponseWriter, r *http.Request) {
			...
			handle.SingleUseCaseRequest(
				w,
				r,
				read.NewRequest(dtoBase.NewRequest(correlationid.Get(r)), vars[id]),
				version,
				Kind,
				Action,
				router,
