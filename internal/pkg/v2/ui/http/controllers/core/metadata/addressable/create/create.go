...
import (
	...
	useCase "github.com/edgexfoundry/edgex-go/internal/pkg/v2/application/usecases/core/metadata/addressable/create"
...
const (
	...
	Kind     = application.KindAddressableAdd
	Action   = application.ActionCreate
	Method   = controllers.ActionCreate
