...
import (
	...
	validator "github.com/edgexfoundry/edgex-go/internal/pkg/v2/application/validator/core/metadata/addressable/delete"
...
func (uc *useCase) Execute(r interface{}) (interface{}, infrastructure.Status) {
	...
	status := uc.persistence.Remove(infrastructure.StringToIdentity(request.ID))
