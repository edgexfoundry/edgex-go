...
// sqlQueryContentWithNamedArgAndPagination returns the SQL statement for selecting content column from the table with pagination
func sqlQueryContentWithNamedArgAndPagination(table string) string {
...
// sqlQueryContentByJSONFieldAndNamedArgWithPagination returns the SQL statement for selecting content column in the table by the given JSON query string with pagination
func sqlQueryContentByJSONFieldAndNamedArgWithPagination(table string) string {
