...
func (_m *SchedulerClient) AddInterval(interval models.Interval) errors.EdgeX {
...
func (_m *SchedulerClient) AddIntervalAction(intervalAction models.IntervalAction) errors.EdgeX {
...
func (_m *SchedulerClient) DeleteIntervalActionByName(name string) errors.EdgeX {
	ret := _m.Called(name)
...
func (_m *SchedulerClient) DeleteIntervalByName(name string) errors.EdgeX {
	ret := _m.Called(name)
...
func (_m *SchedulerClient) IntervalActionByName(name string) (models.IntervalAction, errors.EdgeX) {
	ret := _m.Called(name)
...
func (_m *SchedulerClient) IntervalByName(intervalName string) (models.Interval, errors.EdgeX) {
...
func (_m *SchedulerClient) StartTicker() {
	_m.Called()
}

// StopTicker provides a mock function with given fields:
func (_m *SchedulerClient) StopTicker() {
	_m.Called()
}

// UpdateInterval provides a mock function with given fields: interval
func (_m *SchedulerClient) UpdateInterval(interval models.Interval) errors.EdgeX {
	ret := _m.Called(interval)
...
func (_m *SchedulerClient) UpdateIntervalAction(intervalAction models.IntervalAction) errors.EdgeX {
	ret := _m.Called(intervalAction)
