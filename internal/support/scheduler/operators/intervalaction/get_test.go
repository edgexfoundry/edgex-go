...
func createMockIntervalActionsSuccess() IntervalActionLoader {
	...
	dbMock.On("IntervalActionsWithLimit", TestLimit).Return(IntervalActions, nil)
	return &dbMock
}
...
func createMockIntervalActionsFail() IntervalActionLoader {
	...
	dbMock.On("IntervalActionsWithLimit", TestLimit).Return([]contract.IntervalAction{}, Error)
	return &dbMock
}
