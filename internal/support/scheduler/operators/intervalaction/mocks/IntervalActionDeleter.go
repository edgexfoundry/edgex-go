...
// IntervalActionDeleter is an autogenerated mock type for the IntervalActionDeleter type
type IntervalActionDeleter struct {
	mock.Mock
}

// IntervalActionById provides a mock function with given fields: id
func (_m *IntervalActionDeleter) IntervalActionById(id string) (models.IntervalAction, error) {
	ret := _m.Called(id)
...
func (_m *IntervalActionDeleter) IntervalActionByName(name string) (models.IntervalAction, error) {
	ret := _m.Called(name)
...
func (_m *IntervalActionDeleter) IntervalActions() ([]models.IntervalAction, error) {
	ret := _m.Called()
...
func (_m *IntervalActionDeleter) IntervalActionsWithLimit(limit int) ([]models.IntervalAction, error) {
	ret := _m.Called(limit)
...
func (_m *IntervalActionDeleter) IntervalById(id string) (models.Interval, error) {
	ret := _m.Called(id)
...
func (_m *IntervalActionDeleter) IntervalByName(name string) (models.Interval, error) {
	ret := _m.Called(name)
...
func (_m *IntervalActionDeleter) Intervals() ([]models.Interval, error) {
	ret := _m.Called()
...
func (_m *IntervalActionDeleter) IntervalsWithLimit(limit int) ([]models.Interval, error) {
	ret := _m.Called(limit)
