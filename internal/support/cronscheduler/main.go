...
func Main(ctx context.Context, cancel context.CancelFunc, router *echo.Echo) {
	startupTimer := startup.NewStartUpTimer(common.SupportCronSchedulerServiceKey)
	...
	httpServer := handlers.NewHttpServer(router, true, common.SupportCronSchedulerServiceKey)
	...
	bootstrap.Run(
		...
		[]interfaces.BootstrapHandler{
			...
			handlers.NewStartMessage(common.SupportCronSchedulerServiceKey, edgex.Version).BootstrapHandler,
		})
}
