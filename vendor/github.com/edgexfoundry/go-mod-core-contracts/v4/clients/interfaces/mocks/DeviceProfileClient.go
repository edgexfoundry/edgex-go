...
// UpdateDeviceProfileTags provides a mock function with given fields: ctx, profileName, request
func (_m *DeviceProfileClient) UpdateDeviceProfileTags(ctx context.Context, profileName string, request requests.DeviceProfileTagsRequest) (common.BaseResponse, errors.EdgeX) {
	ret := _m.Called(ctx, profileName, request)

	if len(ret) == 0 {
		panic("no return value specified for UpdateDeviceProfileTags")
	}

	var r0 common.BaseResponse
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(context.Context, string, requests.DeviceProfileTagsRequest) (common.BaseResponse, errors.EdgeX)); ok {
		return rf(ctx, profileName, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, requests.DeviceProfileTagsRequest) common.BaseResponse); ok {
		r0 = rf(ctx, profileName, request)
	} else {
		r0 = ret.Get(0).(common.BaseResponse)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, requests.DeviceProfileTagsRequest) errors.EdgeX); ok {
		r1 = rf(ctx, profileName, request)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(errors.EdgeX)
		}
