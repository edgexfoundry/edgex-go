...
// AllEventsWithQueryParams provides a mock function with given fields: ctx, offset, limit, queryParams
func (_m *EventClient) AllEventsWithQueryParams(ctx context.Context, offset int, limit int, queryParams map[string]string) (responses.MultiEventsResponse, errors.EdgeX) {
	ret := _m.Called(ctx, offset, limit, queryParams)

	if len(ret) == 0 {
		panic("no return value specified for AllEventsWithQueryParams")
	}

	var r0 responses.MultiEventsResponse
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(context.Context, int, int, map[string]string) (responses.MultiEventsResponse, errors.EdgeX)); ok {
		return rf(ctx, offset, limit, queryParams)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int, int, map[string]string) responses.MultiEventsResponse); ok {
...
// EventsByDeviceNameWithQueryParams provides a mock function with given fields: ctx, name, offset, limit, queryParams
func (_m *EventClient) EventsByDeviceNameWithQueryParams(ctx context.Context, name string, offset int, limit int, queryParams map[string]string) (responses.MultiEventsResponse, errors.EdgeX) {
	ret := _m.Called(ctx, name, offset, limit, queryParams)

	if len(ret) == 0 {
		panic("no return value specified for EventsByDeviceNameWithQueryParams")
	}

	var r0 responses.MultiEventsResponse
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(context.Context, string, int, int, map[string]string) (responses.MultiEventsResponse, errors.EdgeX)); ok {
		return rf(ctx, name, offset, limit, queryParams)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, int, int, map[string]string) responses.MultiEventsResponse); ok {
...
// EventsByTimeRangeWithQueryParams provides a mock function with given fields: ctx, start, end, offset, limit, queryParams
func (_m *EventClient) EventsByTimeRangeWithQueryParams(ctx context.Context, start int64, end int64, offset int, limit int, queryParams map[string]string) (responses.MultiEventsResponse, errors.EdgeX) {
	ret := _m.Called(ctx, start, end, offset, limit, queryParams)

	if len(ret) == 0 {
		panic("no return value specified for EventsByTimeRangeWithQueryParams")
	}

	var r0 responses.MultiEventsResponse
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(context.Context, int64, int64, int, int, map[string]string) (responses.MultiEventsResponse, errors.EdgeX)); ok {
		return rf(ctx, start, end, offset, limit, queryParams)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64, int64, int, int, map[string]string) responses.MultiEventsResponse); ok {
