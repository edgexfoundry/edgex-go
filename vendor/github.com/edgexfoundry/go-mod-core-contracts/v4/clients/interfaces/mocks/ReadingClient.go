...
// AllReadingsWithQueryParams provides a mock function with given fields: ctx, offset, limit, queryParams
func (_m *ReadingClient) AllReadingsWithQueryParams(ctx context.Context, offset int, limit int, queryParams map[string]string) (responses.MultiReadingsResponse, errors.EdgeX) {
	ret := _m.Called(ctx, offset, limit, queryParams)

	if len(ret) == 0 {
		panic("no return value specified for AllReadingsWithQueryParams")
	}

	var r0 responses.MultiReadingsResponse
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(context.Context, int, int, map[string]string) (responses.MultiReadingsResponse, errors.EdgeX)); ok {
		return rf(ctx, offset, limit, queryParams)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int, int, map[string]string) responses.MultiReadingsResponse); ok {
		r0 = rf(ctx, offset, limit, queryParams)
	} else {
		r0 = ret.Get(0).(responses.MultiReadingsResponse)
	}

	if rf, ok := ret.Get(1).(func(context.Context, int, int, map[string]string) errors.EdgeX); ok {
		r1 = rf(ctx, offset, limit, queryParams)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(errors.EdgeX)
		}
...
// ReadingsByDeviceNameAndResourceNameAndTimeRangeWithQueryParams provides a mock function with given fields: ctx, deviceName, resourceName, start, end, offset, limit, queryParams
func (_m *ReadingClient) ReadingsByDeviceNameAndResourceNameAndTimeRangeWithQueryParams(ctx context.Context, deviceName string, resourceName string, start int64, end int64, offset int, limit int, queryParams map[string]string) (responses.MultiReadingsResponse, errors.EdgeX) {
	ret := _m.Called(ctx, deviceName, resourceName, start, end, offset, limit, queryParams)

	if len(ret) == 0 {
		panic("no return value specified for ReadingsByDeviceNameAndResourceNameAndTimeRangeWithQueryParams")
	}

	var r0 responses.MultiReadingsResponse
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(context.Context, string, string, int64, int64, int, int, map[string]string) (responses.MultiReadingsResponse, errors.EdgeX)); ok {
		return rf(ctx, deviceName, resourceName, start, end, offset, limit, queryParams)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, int64, int64, int, int, map[string]string) responses.MultiReadingsResponse); ok {
		r0 = rf(ctx, deviceName, resourceName, start, end, offset, limit, queryParams)
	} else {
		r0 = ret.Get(0).(responses.MultiReadingsResponse)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, string, int64, int64, int, int, map[string]string) errors.EdgeX); ok {
		r1 = rf(ctx, deviceName, resourceName, start, end, offset, limit, queryParams)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(errors.EdgeX)
		}
...
// ReadingsByDeviceNameAndResourceNameWithQueryParams provides a mock function with given fields: ctx, deviceName, resourceName, offset, limit, queryParams
func (_m *ReadingClient) ReadingsByDeviceNameAndResourceNameWithQueryParams(ctx context.Context, deviceName string, resourceName string, offset int, limit int, queryParams map[string]string) (responses.MultiReadingsResponse, errors.EdgeX) {
	ret := _m.Called(ctx, deviceName, resourceName, offset, limit, queryParams)

	if len(ret) == 0 {
		panic("no return value specified for ReadingsByDeviceNameAndResourceNameWithQueryParams")
	}

	var r0 responses.MultiReadingsResponse
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(context.Context, string, string, int, int, map[string]string) (responses.MultiReadingsResponse, errors.EdgeX)); ok {
		return rf(ctx, deviceName, resourceName, offset, limit, queryParams)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, int, int, map[string]string) responses.MultiReadingsResponse); ok {
		r0 = rf(ctx, deviceName, resourceName, offset, limit, queryParams)
	} else {
		r0 = ret.Get(0).(responses.MultiReadingsResponse)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, string, int, int, map[string]string) errors.EdgeX); ok {
		r1 = rf(ctx, deviceName, resourceName, offset, limit, queryParams)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(errors.EdgeX)
		}
...
// ReadingsByDeviceNameAndResourceNamesAndTimeRangeWithQueryParams provides a mock function with given fields: ctx, deviceName, resourceNames, start, end, offset, limit, queryParams
func (_m *ReadingClient) ReadingsByDeviceNameAndResourceNamesAndTimeRangeWithQueryParams(ctx context.Context, deviceName string, resourceNames []string, start int64, end int64, offset int, limit int, queryParams map[string]string) (responses.MultiReadingsResponse, errors.EdgeX) {
	ret := _m.Called(ctx, deviceName, resourceNames, start, end, offset, limit, queryParams)

	if len(ret) == 0 {
		panic("no return value specified for ReadingsByDeviceNameAndResourceNamesAndTimeRangeWithQueryParams")
	}

	var r0 responses.MultiReadingsResponse
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(context.Context, string, []string, int64, int64, int, int, map[string]string) (responses.MultiReadingsResponse, errors.EdgeX)); ok {
		return rf(ctx, deviceName, resourceNames, start, end, offset, limit, queryParams)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, []string, int64, int64, int, int, map[string]string) responses.MultiReadingsResponse); ok {
		r0 = rf(ctx, deviceName, resourceNames, start, end, offset, limit, queryParams)
	} else {
		r0 = ret.Get(0).(responses.MultiReadingsResponse)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, []string, int64, int64, int, int, map[string]string) errors.EdgeX); ok {
		r1 = rf(ctx, deviceName, resourceNames, start, end, offset, limit, queryParams)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(errors.EdgeX)
		}
...
// ReadingsByDeviceNameWithQueryParams provides a mock function with given fields: ctx, name, offset, limit, queryParams
func (_m *ReadingClient) ReadingsByDeviceNameWithQueryParams(ctx context.Context, name string, offset int, limit int, queryParams map[string]string) (responses.MultiReadingsResponse, errors.EdgeX) {
	ret := _m.Called(ctx, name, offset, limit, queryParams)

	if len(ret) == 0 {
		panic("no return value specified for ReadingsByDeviceNameWithQueryParams")
	}

	var r0 responses.MultiReadingsResponse
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(context.Context, string, int, int, map[string]string) (responses.MultiReadingsResponse, errors.EdgeX)); ok {
		return rf(ctx, name, offset, limit, queryParams)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, int, int, map[string]string) responses.MultiReadingsResponse); ok {
		r0 = rf(ctx, name, offset, limit, queryParams)
	} else {
		r0 = ret.Get(0).(responses.MultiReadingsResponse)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, int, int, map[string]string) errors.EdgeX); ok {
		r1 = rf(ctx, name, offset, limit, queryParams)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(errors.EdgeX)
		}
...
// ReadingsByResourceNameAndTimeRangeWithQueryParams provides a mock function with given fields: ctx, name, start, end, offset, limit, queryParams
func (_m *ReadingClient) ReadingsByResourceNameAndTimeRangeWithQueryParams(ctx context.Context, name string, start int64, end int64, offset int, limit int, queryParams map[string]string) (responses.MultiReadingsResponse, errors.EdgeX) {
	ret := _m.Called(ctx, name, start, end, offset, limit, queryParams)

	if len(ret) == 0 {
		panic("no return value specified for ReadingsByResourceNameAndTimeRangeWithQueryParams")
	}

	var r0 responses.MultiReadingsResponse
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(context.Context, string, int64, int64, int, int, map[string]string) (responses.MultiReadingsResponse, errors.EdgeX)); ok {
		return rf(ctx, name, start, end, offset, limit, queryParams)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, int64, int64, int, int, map[string]string) responses.MultiReadingsResponse); ok {
		r0 = rf(ctx, name, start, end, offset, limit, queryParams)
	} else {
		r0 = ret.Get(0).(responses.MultiReadingsResponse)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, int64, int64, int, int, map[string]string) errors.EdgeX); ok {
		r1 = rf(ctx, name, start, end, offset, limit, queryParams)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(errors.EdgeX)
		}
...
// ReadingsByResourceNameWithQueryParams provides a mock function with given fields: ctx, name, offset, limit, queryParams
func (_m *ReadingClient) ReadingsByResourceNameWithQueryParams(ctx context.Context, name string, offset int, limit int, queryParams map[string]string) (responses.MultiReadingsResponse, errors.EdgeX) {
	ret := _m.Called(ctx, name, offset, limit, queryParams)

	if len(ret) == 0 {
		panic("no return value specified for ReadingsByResourceNameWithQueryParams")
	}
...
// ReadingsByTimeRangeWithQueryParams provides a mock function with given fields: ctx, start, end, offset, limit, queryParams
func (_m *ReadingClient) ReadingsByTimeRangeWithQueryParams(ctx context.Context, start int64, end int64, offset int, limit int, queryParams map[string]string) (responses.MultiReadingsResponse, errors.EdgeX) {
	ret := _m.Called(ctx, start, end, offset, limit, queryParams)

	if len(ret) == 0 {
		panic("no return value specified for ReadingsByTimeRangeWithQueryParams")
	}

	var r0 responses.MultiReadingsResponse
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(context.Context, int64, int64, int, int, map[string]string) (responses.MultiReadingsResponse, errors.EdgeX)); ok {
		return rf(ctx, start, end, offset, limit, queryParams)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64, int64, int, int, map[string]string) responses.MultiReadingsResponse); ok {
		r0 = rf(ctx, start, end, offset, limit, queryParams)
	} else {
		r0 = ret.Get(0).(responses.MultiReadingsResponse)
	}

	if rf, ok := ret.Get(1).(func(context.Context, int64, int64, int, int, map[string]string) errors.EdgeX); ok {
		r1 = rf(ctx, start, end, offset, limit, queryParams)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(errors.EdgeX)
		}
